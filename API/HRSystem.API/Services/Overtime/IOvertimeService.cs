...
public interface IOvertimeService
{
    ...
    Task<List<OvertimeRecordDto>> GetPendingInScopeAsync(int approverEmployeeId);
    Task<List<OvertimeRecordDto>> ListAsync(OvertimeFilterDto filter);
    Task<OvertimeRecordDto?> RecommendAsync(int recordId, int recommenderEmployeeId, string? comments);
